...
| Library screen | Partial code evidence collected; manual screenshot evidence pending. | 2026-04-25 | Unit tests | Debug | M7 adds Library tab with browse/open/archive/restore/delete and row preview; `LibraryViewModelTest` covers lifecycle behavior. | Add emulator screenshots/manual evidence. | M12/M13 |
