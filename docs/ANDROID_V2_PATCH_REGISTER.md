...
| P002 | Documentation control plane | In progress | Add premium migration documentation package and living-doc rules. | `docs/`, `docs/adr/` | `git diff --check`; `git status`; docs secret scan | All control-plane docs | Stale docs, disconnected requirements, unresolved provider/security decisions | Commit pending | 2026-04-25 | Final commit hash to be reported after commit. |
