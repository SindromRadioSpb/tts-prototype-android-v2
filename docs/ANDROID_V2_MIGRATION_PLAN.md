...
| M11 - Import/compatibility layer | Medium | Import Android ZIP and compatible old web JSON where possible. | Import fixture tests and partial import tests. | Import remains read-only preview until safe. | P016 implements old web JSON import; P029 wires Android Library v3 ZIP bundle import with audio through SAF. |
