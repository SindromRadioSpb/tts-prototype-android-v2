...
| M11 - Import/compatibility layer | Medium | Import Android ZIP and compatible old web JSON where possible. | Import fixture tests and partial import tests. | Import remains read-only preview until safe. | Partially implemented by P016 for old web JSON; Android ZIP import remains future. |
